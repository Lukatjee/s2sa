        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            <div
                ...
                <div class="rounded-3xl p-8 ring-1 ring-gray-200">
                    <h3 id="koper" class="text-lg font-semibold leading-8 text-gray-900">Koper</h3>
                    <p class="mt-4 text-sm leading-6 text-gray-600">Koperen steun, geleidend resultaat.</p>
                    ...
                    <a href="https://donate.stripe.com/cN2dUjfQl8qjb4seUV" target="_blank" aria-describedby="koper"
                ...
                <div class="rounded-3xl p-8 ring-1 ring-gray-200">
                    <h3 id="bronze" class="text-lg font-semibold leading-8 text-gray-900">Bronze</h3>
                    <p class="mt-4 text-sm leading-6 text-gray-600">Een bronzen bijdrage, een gouden hart.</p>
                    <p class="mt-6 flex items-baseline gap-x-1">
                        <span class="text-sm font-semibold leading-6 text-gray-600">vanaf</span>
                        <span class="text-4xl font-bold tracking-tight text-gray-900">€125</span>
                    </p>
                    <a href="https://donate.stripe.com/6oEaI7bA5fSL2xW7sz" target="_blank" aria-describedby="bronze"
                       class="mt-6 block rounded-md py-2 px-3 text-center text-sm font-semibold leading-6 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-red-600 text-red-600 ring-1 ring-inset ring-red-200 hover:ring-red-300">Doe
                        mee</a>
                    <ul role="list" class="mt-8 space-y-3 text-sm leading-6 text-gray-600">
                        <li class="flex gap-x-3">
                            ...
                            1 VIP-kaart voor het slotevenement op 25/05/2024
                        </li>
                        <li class="flex gap-x-3">
                            <svg class="h-6 w-5 flex-none text-red-600" viewBox="0 0 20 20" fill="currentColor"
                                 aria-hidden="true">
                            ...
                            VIP Tafel voor 1 persoon met 3 drankbonnetjes & hapjes
                        </li>
                        <li class="flex gap-x-3">
                            <svg class="h-6 w-5 flex-none text-red-600" viewBox="0 0 20 20" fill="currentColor"
                                 aria-hidden="true">
                ...
                <div class="rounded-3xl p-8 ring-1 ring-gray-200">
                    <h3 id="silver" class="text-lg font-semibold leading-8 text-gray-900">Silver</h3>
                    <p class="mt-4 text-sm leading-6 text-gray-600">Zilveren steun, schitterend resultaat.</p>
                    <p class="mt-6 flex items-baseline gap-x-1">
                        <span class="text-sm font-semibold leading-6 text-gray-600">vanaf</span>
                        <span class="text-4xl font-bold tracking-tight text-gray-900">€175</span>
                    </p>
                    <a href="https://donate.stripe.com/fZe6rR8nT7mf3C08wy" target="_blank" aria-describedby="silver"
                       class="mt-6 block rounded-md py-2 px-3 text-center text-sm font-semibold leading-6 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-red-600 text-red-600 ring-1 ring-inset ring-red-200 hover:ring-red-300">Doe
                        mee</a>
                    <ul role="list" class="mt-8 space-y-3 text-sm leading-6 text-gray-600">
                        <li class="flex gap-x-3">
                            ...
                            2 VIP-kaarten voor het slotevenement op 25/05/2024
                        </li>
                        <li class="flex gap-x-3">
                            <svg class="h-6 w-5 flex-none text-red-600" viewBox="0 0 20 20" fill="currentColor"
                                 aria-hidden="true">
                            ...
                            VIP Tafel voor 2 personen met 1 fles cava & hapjes
                        </li>
                        <li class="flex gap-x-3">
                            <svg class="h-6 w-5 flex-none text-red-600" viewBox="0 0 20 20" fill="currentColor"
                                 aria-hidden="true">
                ...
                <div class="rounded-3xl p-8 ring-2 ring-red-600">
                    <h3 id="golden" class="text-lg font-semibold leading-8 text-red-600">Golden</h3>
                    <p class="mt-4 text-sm leading-6 text-gray-600">Met jouw gouden steun schijnen we helderder.</p>
                    <p class="mt-6 flex items-baseline gap-x-1">
                        <span class="text-sm font-semibold leading-6 text-gray-600">vanaf</span>
                        <span class="text-4xl font-bold tracking-tight text-gray-900">€250</span>
                    </p>
                    <a href="https://donate.stripe.com/28o6rRcE98qj4G47sv" target="_blank" aria-describedby="golden"
                    ...
                    <ul role="list" class="mt-8 space-y-3 text-sm leading-6 text-gray-600">
                        <li class="flex gap-x-3">
                            ...
                            4 VIP-kaarten voor het slotevenement op 25/05/2024
                        </li>
                        <li class="flex gap-x-3">
                            <svg class="h-6 w-5 flex-none text-red-600" viewBox="0 0 20 20" fill="currentColor"
                                 aria-hidden="true">
                            ...
                            VIP Tafel voor 4 personen met 2 flessen cava & hapjes
                        </li>
                        <li class="flex gap-x-3">
                            <svg class="h-6 w-5 flex-none text-red-600" viewBox="0 0 20 20" fill="currentColor"
                                 aria-hidden="true">
                ...
                <div class="rounded-3xl p-8 ring-1 ring-gray-200">
                    <h3 id="diamond" class="text-lg font-semibold leading-8 text-gray-900">Diamond</h3>
                    ...
                    <a href="https://donate.stripe.com/00g7vVgUpgWP6Oc28c" target="_blank" aria-describedby="diamond"
                       class="mt-6 block rounded-md py-2 px-3 text-center text-sm font-semibold leading-6 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-red-600 text-red-600 ring-1 ring-inset ring-red-200 hover:ring-red-300">Doe
                        mee</a>
                    <ul role="list" class="mt-8 space-y-3 text-sm leading-6 text-gray-600">
                        <li class="flex gap-x-3">
                ...
                <div class="rounded-3xl p-8 ring-1 ring-gray-200">
                    <h3 id="platinum" class="text-lg font-semibold leading-8 text-gray-900">Platinum</h3>
                    <p class="mt-4 text-sm leading-6 text-gray-600">Platinum: Waar weelde en klasse een perfecte balans vinden.</p>
                    <p class="mt-6 flex items-baseline gap-x-1">
                        <span class="text-sm font-semibold leading-6 text-gray-600">vanaf</span>
                        <span class="text-4xl font-bold tracking-tight text-gray-900">€1.500</span>
                    </p>
                    <a href="https://donate.stripe.com/00gdUjbA56ibegE6ot" target="_blank" aria-describedby="platinum"
                       class="mt-6 block rounded-md py-2 px-3 text-center text-sm font-semibold leading-6 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-red-600 text-red-600 ring-1 ring-inset ring-red-200 hover:ring-red-300">Doe
                        mee</a>
                    <ul role="list" class="mt-8 space-y-3 text-sm leading-6 text-gray-600">
                        <li class="flex gap-x-3">
                ...
                <div class="rounded-3xl p-8 ring-1 ring-gray-200">
                    <h3 id="exclusive" class="text-lg font-semibold leading-8 text-gray-900">Exclusive</h3>
                    <p class="mt-4 text-sm leading-6 text-gray-600">Exclusieve partnerschap, grenzeloze impact.</p>
                    <p class="mt-6 flex items-baseline gap-x-1">
                        <span class="text-sm font-semibold leading-6 text-gray-600">vanaf</span>
                        <span class="text-4xl font-bold tracking-tight text-gray-900">€2.500</span>
                    </p>
                    <a href="https://donate.stripe.com/bIY5nN7jPgWPgoMaEK" target="_blank" aria-describedby="exclusive"
                    ...
                    <ul role="list" class="mt-8 space-y-3 text-sm leading-6 text-gray-600">
                        <li class="flex gap-x-3">
                            ...
                            10 VIP-kaarten voor het slotevenement op 25/05/2024
                        </li>
                        <li class="flex gap-x-3">
                            <svg class="h-6 w-5 flex-none text-red-600" viewBox="0 0 20 20" fill="currentColor"
                                 aria-hidden="true">
